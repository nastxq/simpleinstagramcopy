...
@method('PATCH')
    <div class="col-8 offset-2">
      <div class="form-group row">
                            ...
                            <label for="title" class="col-md-4 col-form-label text-md-left"><h2>{{ __('title') }}</h2></label>
...
<label for="description" class="col-md-4 col-form-label text-md-left"><h2>{{ __('description') }}</h2></label>
...
<label for="url" class="col-md-4 col-form-label text-md-left"><h2>{{ __('url') }}</h2></label>
    ...
    @enderror
                ...
                <div class="row">
                            <label for="image" class="col-md-4 col-form-label text-md-left"><h3>{{ __('Profile Image') }}</h3></label>
